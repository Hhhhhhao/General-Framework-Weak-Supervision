...
def create_config_sim_conf(seed, 
                           algorithm,
    ...
    # save config
    cfg['save_dir'] = f'./saved_models/sim_conf/{setting}/{algorithm}'
    cfg['save_name'] = None
    cfg['resume'] = False
    cfg['load_path'] = None
    cfg['overwrite'] = True
    ...
    if algorithm == 'sconf_relu_sim_conf':
        cfg['activation'] = 'relu'
    elif algorithm == 'sconf_abs_sim_conf':
        cfg['activation'] = 'abs'
    elif algorithm == 'sconf_nn_abs_sim_conf':
        cfg['activation'] = 'nn_abs'
    elif algorithm == 'imp_sim_conf':
...
def exp_classic_cv():
    config_file = r'./config/sim_conf/classic_cv'
    save_path = r'./saved_models/sim_conf/classic_cv'
    ...
    algorithms = ['imp_sim_conf', 'sconf_unbiased_sim_conf', 'sconf_relu_sim_conf', 'sconf_abs_sim_conf', 'sconf_nn_abs_sim_conf']
    
    # algorithms = ['imp_sim_conf']
