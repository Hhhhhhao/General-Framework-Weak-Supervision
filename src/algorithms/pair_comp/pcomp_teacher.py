...
class PCompTeacherPairComparisonLearning(ImprecisePairComparisonLearning):
    ...
    def train_step(self, x_bag_w, x_bag_s):
        ...
        # compute unsup loss
        unsup_loss = self.ce_loss(logits_x_ins_s, logits_x_ins_w.softmax(dim=1), reduction='mean')
        ...
        sup_loss = pho_1 * loss_1 + pho_0 * loss_0
