...
from src.core.nfa import create_sim_conf_graph


from src.datasets import get_sim_conf_labels, get_data, get_dataloader, ImgBaseDataset, ImageTwoViewBagDataset


class ImpreciseSimilarConfidenceLearning(AlgorithmBase):
    ...
    def set_dataset(self):
        ...
        # make partial labels
        train_pos_data, train_conf_targets = get_sim_conf_labels(train_data, train_targets, self.num_classes,
        ...
        train_dataset = ImageTwoViewBagDataset(self.args.dataset, train_pos_data, train_conf_targets,
                                               ...
                                               aggregation='sim_conf',
                                               return_target=True,
                                               return_keys=['x_bag_w', 'x_bag_s', 'y_bag_sim', 'y_ins'])
    ...
    def train_step(self, x_bag_w, x_bag_s, y_bag_sim):
        ...
        pseudo_probs_x_bag, count_probs_x_bag = create_sim_conf_graph(torch.log(probs_x_bag_w), y_bag_sim)
        
        # calculate loss
        sup_loss = self.bce_loss(count_probs_x_bag.squeeze(), y_bag_sim, reduction='mean')
